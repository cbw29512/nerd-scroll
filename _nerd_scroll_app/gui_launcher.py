...
class NerdScrollGui:
    ...
    def _seed_and_refresh_packs(self) -> None:
        """Seed bundled starter packs once, then refresh the dropdown."""
        try:
            ...
            logging.getLogger("nerd_scroll.gui").exception("failed to seed starter packs")
    ...
    def _build_ui(self) -> None:
        ...
        self.text_box.insert("1.0", "Paste text here, or load one of the included starter packs above...\n")
